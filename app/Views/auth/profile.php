...
<?= $this->section('main') ?>
  ...
  <div class="card p-3 my-3">
    <form action="<?= site_url('change-password'); ?>" method="POST" accept-charset="UTF-8" onsubmit="changePassword.disabled = true; return true;">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Repita nueva contraseña</label>
        <div class="col-sm-10">
      ...
      <div class="form-group row">
        <div class="col-sm-10">
          <button name="changePassword" type="submit" class="btn btn-primary">Guardar contraseña</button>
        </div>
      </div>
    </form>
  </div>
