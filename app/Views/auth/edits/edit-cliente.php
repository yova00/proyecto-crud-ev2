    ...
    <div class="card p-3">
        <form action="<?= site_url('unidades/update-unidad'); ?>" method="POST" accept-charset="UTF-8" onsubmit="Button.disabled = true; return true;">
            ...
            <div class="form-group">
                ...
                <input class="form-control" required type="text" name="direccion" value="<?= $unidade['direccion'] ?>" />
            </div>
            <div class="form-group">
                <label for="telefono">Telefono</label>
                <input class="form-control" required type="text" name="telefono" value="<?= $unidade['telefono'] ?>" /> 
            </div>
            <div class="form-group">
                <label for="correo">Correo</label>
                <input class="form-control" required type="text" name="correo" value="<?= $unidade['correo'] ?>" />
            </div>
