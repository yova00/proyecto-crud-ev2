...
<?= $this->section('main') ?>
    ...
    <div class="card p-3 my-3">
        <form action="<?= site_url('settings-update-system'); ?>" method="POST" accept-charset="UTF-8" onsubmit="saveSystem.disabled = true; return true;">
          ...
          <div class="col-md-6">
            <h6 class="pb-2 mb-0 mt-4">Configuracion del sistema</h6>
            <p class="text-muted">Selecciona zona horaria</p>
            <div class="form-group">
                <label for="language" class="form-control-label">Selecciona idioma</label>
                <select class="form-control" name="language">
                    <option value="en" <?php if ($system['language'] == 'en') : ?> selected <?php endif ?> >English</option>
                    <option value="es" <?php if ($system['language'] == 'es') : ?> selected <?php endif ?> >Español</option>
                    <option value="fr" <?php if ($system['language'] == 'fr') : ?> selected <?php endif ?> >French</option>
                </select>
            </div>
            <div class="form-group">
                <label for="timezone" class="form-control-label">Zona horaria</label>
            ...
            <div class="form-group">
                <label for="dateformat" class="form-control-label">Formato de fecha</label>
            ...
            <div class="form-group">
                <label for="timeformat" class="form-control-label">Formato de hora</label>
                <select class="form-control" name="timeformat">
                    <option value="12" <?php if ($system['timeformat'] == '12') : ?> selected <?php endif ?> >12 horas (00:00 AM/PM)</option>
                    <option value="24" <?php if ($system['timeformat'] == '24') : ?> selected <?php endif ?> >24 horas (24:00)</option>
                </select>
            </div>
            <div class="form-group">
                <label class="form-control-label">Restriccion de ip</label>
                <textarea class="form-control" name="iprestriction" rows="3" placeholder="Ingresa aca la ip que quieras bloquear acceso a la web"><?= $system['iprestriction'] ?></textarea>
            </div>
            <div class="form-group">
                <input type="hidden" name="id" value="1">
                <button class="btn btn-primary" id="savesystem" type="submit">Guardar cambios</button>
            </div>
        </div>
        </form>
    </div>    
