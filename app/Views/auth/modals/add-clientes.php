  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createuserformmodaltitle">Agregar Cliente</h5>
      ...
      <div class="modal-body">
        ...
        <form action="<?= site_url('clientes/create-cliente'); ?>" method="POST" accept-charset="UTF-8" onsubmit="registerButton.disabled = true; return true;">
            <?= csrf_field() ?>
            ...
            <div class="form-group row">
                <div class="col">
                    ...
                    <input class="form-control" required type="text" name="direccion" value="<?= old('direccion') ?>" placeholder="Ingresa direccion  "/>
                </div>
            </div>
            <div class="form-group row">
                <div class="col">
                    <label for="telefono">Telefono</label>
                    <input class="form-control" required type="text" name="telefono" value="<?= old('telefono') ?>" placeholder="Ingresa telefono  "/>
                </div>
            </div>
            <div class="form-group row">
                <div class="col">
